            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="includes/allcodes.php?deletepostid=<?php echo $row["Id"]; ?>&pagename=../admin.php" class="btn btn-danger">
                    Delete
                  </a>
                </td>
              </tr>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            ?>
              <tr>
                <td><?php echo $anum; ?></td>
                <td><img src="uploads/<?php echo $row["Profile_img"]; ?>" alt="" ></td>
                <td><?php echo $row["Firstname"]; ?></td>
                <td><?php echo $row["Email"]; ?></td>
                <td>
                  <a href="<?php echo $row["Status"] == 1 ? "" : "includes/allcodes.php?approveid=".$row["Id"]."&pagename=../admin.php"; ?> " class="btn  <?php echo $row["Status"] == 1 ? "" : "btn-secondary"; ?>">
                    <?php echo $row["Status"] == 1 ? 'Approved' : 'Approve '.$row["Firstname"];?>
                  </a>
                  <a href="includes/allcodes.php?deleteuserid=<?php echo $row["Id"]; ?>&pagename=../admin.php" class="btn btn-danger">
                    Delete
                  </a>
                </td>
              </tr>
